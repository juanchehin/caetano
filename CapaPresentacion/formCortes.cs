...
{
    public partial class formCortes : Form
    {
        CN_Cortes objetoCN = new CN_Cortes();
        ...
        {
            dataListadoClientes.DataSource = objetoCN.MostrarCortes();
        ...
        {
            Console.WriteLine("this.IdCliente en click nuevo es  : " + this.IdCorte);
        ...
        private void dataListadoCcortes_SelectionChanged(object sender, EventArgs e)
        {
            if (dataListadoClientes.SelectedCells.Count > 0)
            {
                ...
                this.IdCorte = Convert.ToInt32(selectedRow.Cells["IdCorte"].Value);
                Console.WriteLine("El id IdCliente es " + this.IdCorte);
            }
        }
