...
namespace CapaPresentacion
{
    public partial class formUsuarios : Form
    {
        ...
        {
            dataListadoClientes.DataSource = objetoCN.MostrarUsuarios();
        ...
        {
            Console.WriteLine("this.IdUsuario en click nuevo es  : " + this.IdUsuario);
        ...
        private void dataListadoClientes_SelectionChanged(object sender, EventArgs e)
        {
            if (dataListadoClientes.SelectedCells.Count > 0)
            {
                ...
                this.IdUsuario = Convert.ToInt32(selectedRow.Cells["IdUsuario"].Value);
                Console.WriteLine("El id IdCliente es " + this.IdUsuario);
            }
        }
