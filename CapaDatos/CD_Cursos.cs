...
namespace CapaDatos
{
    public class CD_Cursos
    {
        ...
        private string _EstadoCurso;

        private string _TextoBuscar;



        public int IdCorte { get => _IdCurso; set => _IdCurso = value; }
        public string Curso { get => _Curso; set => _Curso = value; }
        public decimal Precio { get => _Precio; set => _Precio = value; }
        public string Descripcion { get => _Descripcion; set => _Descripcion = value; }
        public string EstadoCurso { get => _EstadoCurso; set => _EstadoCurso = value; }
        ...
        public CD_Cursos(int IdCurso, string Curso, decimal Precio, string Descripcion, string EstadoCurso)
        {
        ...
        public DataTable dameCursos()
        {
            ...
            comando.CommandText = "bsp_dame_cursos";
