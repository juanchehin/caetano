...
namespace CapaDatos
{
    public class CD_Transacciones
    {
        ...
        public string ApellidosAlumno { get => _ApellidosAlumno; set => _ApellidosAlumno = value; }
        public string NombresAlumno { get => _NombresAlumno; set => _NombresAlumno = value; }
        public string Curso { get => _Curso; set => _Curso = value; }
        public decimal PrecioCurso { get => _PrecioCurso; set => _PrecioCurso = value; }
        public string ApellidosCliente { get => _ApellidosCliente; set => _ApellidosCliente = value; }
        public string NombresCliente { get => _NombresCliente; set => _NombresCliente = value; }
        public string Corte { get => _Corte; set => _Corte = value; }
        public decimal PrecioCorte { get => _PrecioCorte; set => _PrecioCorte = value; }

        // public string TextoBuscar { get => _TextoBuscar; set => _TextoBuscar = value; }

        //Constructores
        public CD_Transacciones()
        {

        }

        public CD_Transacciones(int IdTransaccion, string TipoPago,string ApellidosAlumno,string NombresAlumno, string Curso,
        ...
        public DataTable dameTransacciones()
        {

            comando.Connection = conexion.AbrirConexion();
            comando.CommandType = CommandType.StoredProcedure;
            comando.CommandText = "bsp_dame_transacciones";
